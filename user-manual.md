...
│   │   ├── ak.h                 # Định nghĩa cơ bản khung AK
...
│
├── app/                         # Tầng ứng dụng
│   ├── app.h                    # Định nghĩa tín hiệu ứng dụng
│   ├── task_life.h/cpp          # Tác vụ giám sát hệ thống
│   ├── task_if.h/cpp            # Tác vụ giao diện
│   ├── task_uart_if.h/cpp       # Tác vụ UART
│   ├── task_dbg.h/cpp           # Tác vụ debug
│   ├── app_bsp.h/cpp            # Trừu tượng hóa board
│   ├── app_data.h/cpp           # Quản lý dữ liệu ứng dụng
│   └── ... (các tác vụ khác)
│
├── sys/                         # Tầng hệ thống
...
│   ├── sys_irq.h                # Quản lý ngắt
│   ├── io_cfg.h                 # Cấu hình I/O
│   ├── button.h, led.h, ...     # Driver thiết bị
│   └── ... (các tiếp liệu khác)
│
